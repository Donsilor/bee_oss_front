	...
	<div class="page-content rootLog-page">
		<div style="padding-bottom: 30px;">
			...
			<el-row :gutter="24" style="margin-top: 15px">
				<el-col :span="3" style="padding-right: 0; ">
					<el-date-picker style="width: 100%" v-model="rootLogForm.select_date" placeholder="今天">
					</el-date-picker>
				</el-col>
				<el-col :span="3" style="padding-right: 0; " class="time-box-col">
					<el-time-picker is-range v-model="rootLogForm.start_end_time" range-separator="至" start-placeholder="开始时间" end-placeholder="结束时间" placeholder="选择时间范围">
					</el-time-picker>
				</el-col>
		...
		<div>
			<el-table :data="rootLogData.tableData" style="width: 100%">
				<el-table-column label="操作" :width="60">
					<template slot-scope="scope">
						<el-button type="text" @click="getDetail(scope.row)">详情</el-button>
					</template>
				</el-table-column>
				<el-table-column v-for="item in rootLogData.tableColumn" :key="item.prop" :prop="item.prop" :show-overflow-tooltip="true" :label="item.label" :width="getWidth(item.prop)" sortable>
					<template slot-scope="scope">
		...
		<el-dialog title="日志详情" :visible.sync="detailFlag" class="rootLogDetail">
			<div class="edit_form">
				<el-form label-width="125px">
					<el-row>
						<el-col :span="12" v-for="(value, key) in logDetail" :key="key">
