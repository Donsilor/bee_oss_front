<template>
	<div class="page-content config-page">
		<div style="position: relative">
			<el-upload ref="uploadFileImg" class="upload-demo" action="/api/index.php/iotrouter/import" :before-upload="beforeAvatarUpload" :on-success="getUploadData" :data="uploadObj" :limit="1">
				<el-button size="small" type="primary">点击导入</el-button>
			</el-upload>
			<el-button type="text" @click="goBack" style="position: absolute;top:0; right: 20px">返回</el-button>
		</div>
		<div style="margin-top: 20px">
			<el-table :data="importList.tableData" style="width: 100%; border-top:0 none">
				<el-table-column v-for="item in importList.tableColumn" :key="item.prop" :prop="item.prop" :label="item.label" :width="'auto'">
