...
style="padding-right: 0; ">
          <el-input v-model="listParams.router_id" 
placeholder="router_id"/>
        </el-col>
        <el-col :span="3" 
style="padding-right: 0; ">
          <el-input v-model="listParams.device_uuid" 
placeholder="device_uuid"/>
        </el-col>
        <el-col :span="2" 
style="padding-right: 0; ">
          <el-button type="primary" 
@click="getRouterList()">&nbsp;&nbsp;查询&nbsp;&nbsp;</el-button>
        </el-col>
      </el-row>
      <div style="position: absolute; top:0; right: 0">
        <el-button-group>
          <el-button @click="openLayer">添加
            <i class="el-icon-caret-bottom"/>
          </el-button>
          <el-button @click="goToImport">批量导入
            <i class="el-icon-caret-bottom"/>
          </el-button>
        </el-button-group>
      </div>
    ...
    <div style="margin-top: 20px">
      <el-table :data="routerList.tableData" 
style="width: 100%; border-top:0 none">
        <el-table-column v-for="item in routerList.tableColumn" 
:key="item.prop" :prop="item.prop" :label="item.label" :width="'auto'">
...
label="操作">
          <template slot-scope="scope">
            <el-button type="text" 
size="small" @click="openEditLayer(scope.row)">编辑</el-button>
            <el-button type="text" 
size="small" @click="delRouter(scope.row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <div class="page-line">
        <el-pagination small 
:total="totalItem" layout="prev, pager, next" :page-size="10" @current-change="pageChange" :current-page.sync="currentPage"/>
      </div>
    </div>
    <!--添加删除-->
    <el-dialog :title="addEditFlag?'添加路由':'编辑路由'" 
:visible.sync="addEditLayer">
      <div class="edit_form">
        <el-form :model="AddEditForm" 
ref="AddEditForm" :rules="rulesAddEdit" label-width="100px">
          <el-row>
            <el-col :span="12">
              <el-form-item label="设备名称" 
prop="device_name">
                <el-input v-model="AddEditForm.device_name" 
placeholder=""/>
              </el-form-item>
            </el-col>
            <el-col :span="12">
...
prop="device_uuid">
                <el-input v-model="AddEditForm.device_uuid" 
placeholder=""/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item label="设备验证KEY" 
prop="device_auth_key">
                <el-input v-model="AddEditForm.device_auth_key" 
placeholder=""/>
              </el-form-item>
            </el-col>
            <el-col :span="12">
...
prop="device_sn">
                <el-input v-model="AddEditForm.device_sn" 
placeholder=""/>
              </el-form-item>
            </el-col>
          </el-row>
...
prop="device_mac">
                <el-input v-model="AddEditForm.device_mac" 
placeholder=""/>
              </el-form-item>
            </el-col>
            <el-col :span="12">
...
prop="device_state">
                <el-select v-model="AddEditForm.device_state" 
placeholder="请选择">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="设备参数">
                <el-input v-model="AddEditForm.device_params" 
placeholder=""/>
              </el-form-item>
            </el-col>
          </el-row>
      ...
      <div style="text-align: right; margin: 0">
        <el-button type="primary" 
@click="addEditConfirm('AddEditForm')">确定</el-button>
