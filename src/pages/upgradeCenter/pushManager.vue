<template>
	<div class="page-content config-page">
		<!--推送历史记录-->
		<div>
			<el-table :data="pushHistoryList.tableData" style="width: 100%; border-top:0 none">
				<el-table-column v-for="item in pushHistoryList.tableColumn" :key="item.prop" :prop="item.prop" :label="item.label" :width="'auto'">
		...
		<el-dialog title="推送详情" :visible.sync="pushDetailFlag">
			<div class="edit_form">
				<el-table :data="pushDetailList.tableData" style="width: 100%; border-top:0 none">
					<el-table-column v-for="item in pushDetailList.tableColumn" :key="item.prop" :prop="item.prop" :label="item.label" :width="'auto'">
						<template slot-scope="scope">
		...
		<el-dialog title="推送名单" :visible.sync="pushNameListFlag">
			<div class="edit_form">
				<el-table :data="pushNameList.tableData" style="width: 100%; border-top:0 none">
					<el-table-column v-for="item in pushNameList.tableColumn" :key="item.prop" :prop="item.prop" :label="item.label" :width="'auto'">
						<template slot-scope="scope">
