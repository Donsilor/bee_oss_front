    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleFormDetail.version"
              placeholder=""
            />
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleFormDetail.description"
              placeholder=""
            />
          </el-form-item>
        </el-col>
      ...
      <el-row>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleFormDetail.download_url_object"
              placeholder=""
            />
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleFormDetail.img_url_object"
              placeholder=""
            />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleFormDetail.release_tm"
              placeholder=""
            />
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleFormDetail.download_file_md5"
              placeholder=""
            />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleFormDetail.created_at"
              placeholder=""
            />
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleFormDetail.updated_at"
              placeholder=""
            />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleFormDetail.delete_at"
              placeholder=""
            />
          </el-form-item>
        </el-col>
