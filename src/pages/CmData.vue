<template>
	<div class="page-content config-page">
			...
			<el-row type="flex" justify="space-between">
				<el-col :span="12">
					...
					<el-select v-model="F_module_name" placeholder="模块名称">
						...
						<el-option v-for="module in moduleList" :key="module" :label="module" :value="module">
						</el-option>
				...
				<el-col :span="2" style="padding-right: 0; ">
					<el-upload class="upload-demo" ref="upload" :on-success="getUploadData" :show-file-list="true" :limit="1" :action="transUrl">
						<el-button type="primary" plain>批量导入</el-button>
					</el-upload>
				</el-col>

				<el-col :span="2" style="padding-right: 0; ">
					<a href="javascript:;" :href="output" download="">
		...
		<!--上传列表显示-->
		<el-dialog title="导入记录" :visible.sync="inputModel" :lock-scroll='false' width="30%" :before-close="handleClose">
			<div v-for="info in uploadData" class="text item" :key="info.msg">
