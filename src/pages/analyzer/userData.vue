				...
				<el-row :gutter="24">
					<el-col :span="24">
						...
						<div class="pull-right retain-filters">
							<el-button type="text" class="btn" :class="{'active': showRetainUnit === 0}" @click="searchRetainByUnit(0)">日</el-button>
							<el-button type="text" class="btn" :class="{'active': showRetainUnit === 1}" @click="searchRetainByUnit(1)" v-if="isShowUnitWeek">周</el-button>
							<el-button type="text" class="btn" :class="{'active': showRetainUnit === 2}" @click="searchRetainByUnit(2)" v-if="isShowUnitMon">月</el-button>
							<el-button type="text" class="btn" :class="{'active': showRetainNum}" style="margin-left: 30px" @click="showRetainNum=true">#</el-button>
							<el-button type="text" class="btn" :class="{'active': !showRetainNum}" @click="showRetainNum=false">%</el-button>
						</div>
					</el-col>
				</el-row>
				<template>
