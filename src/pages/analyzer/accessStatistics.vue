  ...
  <div class="page-content config-page">
    ...
    <div class="network-equipment">
      <el-card shadow="hover">
        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <simple-chart id="chart1" title="累计入网设备数（单位:个）" rotate="45" :result="allEquipmentNum" style="height:400px; width:100%;"></simple-chart>
          </el-col>
          <el-col :span="12">
						<mix-bar-chart id="chart2" :result="newAddEquipmentNum" style="height:400px; width:100%;"></mix-bar-chart>
          </el-col>
        </el-row>
      </el-card>
    </div>
