      ...
      >
        <el-col :span="18">
          <el-button-group v-show="!searchedFlag">
            <el-button @click="pushBoxFlag = true">
              推送升级
            </el-button>
            <el-button @click="statisticsFlag = true">
              设备版本统计
            </el-button>
            <el-button v-popover:filterPopover>
              筛选
          ...
          />
          <el-button @click="searchedFlag = true">
            查询
          </el-button>
        </el-col>
        <el-col
    ...
    <div v-show="statisticsFlag">
      <el-row>
        ...
        <el-col
          ...
          style="text-align: right;"
        >
          <el-button @click="statisticsFlag = false">
            返回
          </el-button>
        </el-col>
      </el-row>
      ...
      >
        <el-tab-pane
          ...
          name="router"
        >
          <p class="statisticsHeader">
            <em>各版本情况</em>
            <span>单位 个</span>
          </p>
          <div
            id="routerEchart-area"
            class="statisticsEchart-area"
          />
        </el-tab-pane>
        <el-tab-pane
          label="app"
        ...
        >
          <div class="statisticsHeader">
            <el-select
              v-model="statisticsFilter.category"
              placeholder="品类"
            >
              <el-option
            ...
            <el-select
              v-model="statisticsFilter.brand"
              placeholder="品牌"
            >
              <el-option
      ...
      <div class="cp-personBox">
        <div class="cppb-infoArea">
          ...
          <div>
            ...
            <p>共{{ facilitysTotal }}个关联设备 {{ unusualfacilitysTotal }}个异常</p>
          </div>
        </div>
        <el-table
          :data="person.facilitys"
          style="width: 100%"
        >
          <el-table-column
            prop="name"
    ...
    >
      ...
      >
        ...
        <el-form-item>
          ...
          <el-button @click="pushBoxFlag = false;">
            取消
          </el-button>
        </el-form-item>
      </el-form>
