      ...
      <div class="edit_form">
        ...
        >
          <el-form-item label="策略组名称">
            <el-input v-model="AddEditForm.F_strategy_name" />
          </el-form-item>
          <el-form-item label="字段类型">
            <el-select
              v-model="AddEditForm.F_type"
              placeholder="请选择"
            >
              <el-option
                label="uuid"
          ...
          <el-form-item label="版本">
            <el-input v-model="AddEditForm.F_version" />
          </el-form-item>
          <el-form-item label="地区">
            <el-input v-model="AddEditForm.F_region" />
          </el-form-item>
          <el-form-item label="终端类型">
            <el-select
              v-model="AddEditForm.F_os_type"
              placeholder="请选择"
            >
              <el-option
                label="Android "
          ...
          <el-form-item label="host列表">
            ...
            <el-select
              v-model="AddEditForm.F_host_list"
              filterable
              placeholder="请选择"
            >
              <el-option
